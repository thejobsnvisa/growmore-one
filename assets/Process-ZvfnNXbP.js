import{r,j as t}from"./index-CeB6uAIS.js";const l=[{img:"/assets/r1.png",title:"Inquiry",text:"Raise query by contacting us through WhatsApp or website."},{img:"/assets/r2.png",title:"Registration",text:"Book a consultation with an RMA and sign the service agreement."},{img:"/assets/r3.png",title:"Documentation",text:"Gather and prepare all required documents."},{img:"/assets/r4.png",title:"Lodgement",text:"Lodge your visa application with precision."},{img:"/assets/r5.png",title:"Support",text:"Receive ongoing guidance throughout the process."}];function m(){const n=r.useRef(null),[a,i]=r.useState(!1);return r.useEffect(()=>{const e=()=>{if(!n.current)return;const s=n.current.getBoundingClientRect().top;i(s<=100)};return window.addEventListener("scroll",e),()=>window.removeEventListener("scroll",e)},[]),t.jsxs("section",{ref:n,className:`relative py-12 sm:py-16 md:py-24 bg-[#eff9fb] overflow-hidden \r
