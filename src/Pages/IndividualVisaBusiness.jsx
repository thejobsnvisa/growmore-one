...
const IndividualVisaBusiness = () => {
  const url = "https://www.growmore.one/our-services/individual/business-investor-visa/";
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Explore the Australia Business Innovation & Investment Visa with GrowMore Immigration. Get expert support on eligibility, streams, and the application process."/>
        ...
        <meta
          property="og:title"
          content="Australia Business Innovation & Investment Visa | GrowMore Immigration"
        />
        <meta
