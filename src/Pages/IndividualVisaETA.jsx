...
const IndividualVisaETA = () => {
  const url ="https://www.growmore.one/our-services/individual/visitor-evisitor-eta-visa/";

  return (
    <>
      <Helmet>
        <title>
         Visiting Australia E-Visitor (Subclass 651) | GrowMore Immigration
        </title>

        <meta
          name="description"
          content="Planning a trip to Australia? Apply for the E-Visitor Visa (Subclass 651) with Growmore Immigration. Get expert help with eligibility, application, and quick approval."
        />
        ...
        <meta
          property="og:title"
          content="Visiting Australia E-Visitor (Subclass 651) | GrowMore Immigration"
        />
        <meta
                ...
                <div>
                  ...
                  <ol className="list-decimal pl-6 mb-3 space-y-4 text-[#727272] text-sm sm:text-base">
                    <li>
                      ...
                      This is an electronic visa for short term stays in
                      Australia for tourism or business purposes. It is open to
                      citizens of certain countries and eligibility criteria
                      include having a valid passport, a return ticket and
                      sufficient funds to support yourself while in Australia.
                    </li>
                    <li>
                      <strong>
                        <span className="text-black font-semibold">
                      ...
                      Similar to the ETA, the eVisitor visa is an electronic
                      visa for citizens of European countries for short-term
                      stays in Australia for tourism or business purposes.
                    </li>
                    <li>
                      <strong>
                        <span className="text-black font-semibold">
                    ...
                    <li>
                      ...
                      This is designed for individuals who wish to visit
                      Australia for tourism, business, or other reasons. This
                      visa category consists of three subclasses, each with its
                  ...
                  <ol className="list-disc pl-8 mb-3 space-y-4 text-[#727272] text-sm sm:text-base">
                    ...
                    <li>
                      ...
                      This stream is for individuals who are being sponsored by
                      an eligible sponsor for a visit to Australia. To be
                      eligible, you must have a valid sponsorship from an
                      eligible sponsor and meet health and character
                      requirements.
                    </li>
                  </ol>
