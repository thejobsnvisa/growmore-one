...
const IndividualVisaRefugee = () => {
  const url ="https://www.growmore.one/our-services/individual/refugee-visa/";
  return (
    <>
      <Helmet>
        <title>Refugee Visa (Subclass 200) | Seeking Safety and Protection | GrowMore Immigration</title>

        <meta
          name="description"
          content="Learn more about GrowMore Immigration's Refugee Visa (Subclass 200) for Australia. Obtain reliable assistance while looking for safety, security, and a fresh start in Australia."
        />
                ...
                <div>
                  ...
                  <ol className="list-decimal pl-6 mb-3 space-y-4 text-[#727272] text-sm sm:text-base">
                    ...
                    <li>
                      ...
                      refugees, and who are unable to return to their home
                    ...
                    <li>
                      ...
                      and are seeking protection but do not meet the criteria
                      for a permanent protection visa.{" "}
                    </li>
                  </ol>

                  <p className="text-[#727272] mb-3 leading-relaxed  text-justify text-sm sm:text-base">
                    <b className="text-black">Note: </b> eligibility criteria
                    and requirements for each stream are subject to change, and
                    it is always advisable to consult a registered migration
                    agent to understand the latest immigration requirements. You
                    can also check DHA website{" "}
