    ...
    <div className="bg-white">
      ...
      <section className="max-w-[1400px] mx-auto px-6 py-10 md:px-15 py-16">
        ...
        <p className="text-[#042325] leading-relaxed mb-2 text-justify mt-[80px] text-justify text-semibold text-[16px] text-semibold text-[16px]">
          ...
          27th January 2023. Growmore & Associates Pty Ltd. is a private company
          registered under the Corporations Act 2001. Growmore & Associates Pty
          Ltd. This Privacy Policy is in accordance with, the Privacy Act 1988,
          The Australian Privacy Principles From Schedule 1 of the Privacy
          Amendment (Enhancing Privacy Protection) Act 2012, Australian Consumer
          Laws, being Schedule 2 to the Competition and Consumer Act 2010, and
          the EU General Data Protection Regulation (GDPR)- where applicable,
          and other applicable laws and regulations under the jurisdiction of
          Victoria, Australia.
        </p>
        <p className="text-[#042325] leading-relaxed mb-2 text-justify text-semibold text-[16px]">
          Our website and Social Media Platforms may use and/or request personal
          data, example- when you book a consultation (whether free or paid)
          and/or request a call-back or subscribe to our blogs, fill up inquiry
          forms, and questionnaires, share payment details, visit and browse
          Growmore & Associates Pty Ltd.’s website, interact with Growmore &
          Associates Pty Ltd electronically, via social media (including
          Facebook, Instagram, LinkedIn, TikTok, YouTube, and Twitter)or contact
          Growmore & Associates Pty Ltd by email, telephone, tags, and comments
          on social media or facsimile.
        </p>
        <p className="text-[#042325] leading-relaxed mb-2 text-justify text-semibold text-[16px]">
          This Privacy Policy (read with the Terms of Use) constitute a binding
          and legally enforceable contract between Growmore & Associates Pty Ltd
          and User.
        </p>
        <p className="text-[#042325] leading-relaxed mb-2 text-justify text-semibold text-[16px]">
          When you access Growmore & Associates Pty Ltd, your computer sends us
          information such as your IP address, the URL on our Website that you
          have visited, the date and time of your visit, and information on your
          browser.
        </p>
        <div className="text-[#042325] leading-relaxed mb-2  px-6 py-2 text-justify text-semibold text-[16px]">
          ...
          <ul className="list-decimal mb-2 pl-6 space-y-2">
            ...
            <li>Associations and affiliates, including trusts and companies</li>
            <li>
              Contact details, including email addresses and telephone numbers
            </li>
            <li>
              Relationships with individuals, including family members, friends,
              and professionals
            </li>
            ...
            <li>
              ...
              which may include internet protocol (IP) addresses, and the time,
        ...
        <div className="text-[#042325] leading-relaxed mb-2  px-6 py-2 text-justify text-semibold text-[16px]">
          ...
          <ul className="list-decimal mb-2 pl-6 space-y-2">
            <li>
              the third party is Growmore & Associates Pty Ltd.’s Related Bodies
              Corporate as defined in the Corporations Act 2001), business
              partners, employees, contractors, credit reporting bodies, or your
              representatives; or
            </li>
            <li>you have consented to the collection of the information; or</li>
            <li>
              Growmore & Associates Pty Ltd is required or authorized under
              Australian law, court/ tribunal, to do so; or
            </li>
            <li>
              it is unreasonable or impracticable to obtain the information from
              you; or
            </li>
        ...
        <div className="text-[#042325] leading-relaxed mb-2  px-6 py-2 text-justify text-semibold text-[16px]">
          <ul className="list-disc mb-2 pl-6 space-y-2 ">
            <li>
              ...
              information. It is a sub-set of personal information that is given
              a higher level of protection. The types of sensitive information
        ...
        <p className="text-[#042325] leading-relaxed mb-2 text-justify text-semibold text-[16px]">
          ...
          of such information. We may be legally permitted to withhold access to
          your personal information (In certain events if permissible by law).
          If we cannot provide access to your information, we will advise you as
          ...
          we can provide access to your information in another form that still
        ...
        <p className="text-[#042325] leading-relaxed mb-2 text-justify text-semibold text-[16px]">
          ...
          Associates Pty Ltd will provide you with the choice to stop receiving
          further direct marketing. Growmore & Associates Pty Ltd may continue
          to market to you up until you choose to stop receiving it if you
          decide not to opt out of receiving future marketing.
        </p>
        <p className="text-[#042325] leading-relaxed mb-2 text-justify text-semibold text-[16px]">
          Correction: Please get in touch with us using the information below if
          you think any information we have on you is unreliable, outdated,
          ...
          be aware that we may occasionally be able to legally refuse to correct
          your personal information. If we are unable to amend your information,
          we will let you know as soon as it is practical, explain why, and let
          you know how to file a complaint if necessary.
        </p>
        <p className="text-[#042325] leading-relaxed mb-2 text-justify text-semibold text-[16px]">
          Overseas disclosure: We will only share your personal information with
          nations that have laws protecting it in a way that is substantially
          similar to the Australian Privacy Principles and the GDPR, unless we
          first ask for and receive your consent to do so, and/or we will take
        ...
        <p className="text-[#042325] leading-relaxed mb-2 text-justify text-semibold text-[16px]">
          We may process/analyze your personal data for the purposes of our own
          legitimate interests, for example, to send promotional emails to
          services relevant to you.
        </p>
        <p className="text-[#042325] leading-relaxed mb-2 text-justify text-semibold text-[16px]">
          Your information will continue to be held and used by Growmore &
          Associates Pty Ltd to contact you in such a way after you cease using
          our services, but you may unsubscribe from such communications.
        </p>
        <p className="text-[#042325] leading-relaxed mb-2 text-justify text-semibold text-[16px]">
          Your personal details will not be passed on to any other companies at
          any point in time or third parties including affiliates and will not
          be added to any third-party mailing lists or databases unless you
          choose to do so at any point in time.
        </p>
        <p className="text-[#042325] leading-relaxed mb-2 text-justify text-semibold text-[16px]">
          By using the website you consent to your personal information being
          collected, held, and used in a legitimate way of conducting business.
        </p>{" "}
        <p className="text-[#042325] leading-relaxed mb-2 text-justify text-semibold text-[16px]">
          By using this immigration services platform, you also confirm that you
          are either the owner of or have the legal right to use and share any
          information that may be required and that your use of the platform
          does not conflict with any laws that may be in force, any contracts
          that you may be bound by, or otherwise harm any person or persons.
        </p>{" "}
        <p className="text-[#042325] leading-relaxed mb-2 text-justify text-semibold text-[16px]">
        ...
        <p className="text-[#042325] leading-relaxed mb-2 text-justify text-semibold text-[16px]">
          ...
          website. The cookies that Growmore & Associates Pty Ltd utilizes don’t
          let users be specifically identified. Cookies may be used by Growmore
          & Associates Pty Ltd for specialized web advertising. Most web
          browsers have cookie acceptance turned on. You can set your internet
          browser to refuse cookies or to alert you when they are being used if
          you’d prefer not to receive them. Check your browser’s settings for
          further information.
        </p>
        <div className=" mx-auto text-[#042325] leading-relaxed">
          ...
          <p className="mb-2">
            The Right to Have Your Personal Information Deleted:At any time, you
            have the right to request that Growmore & Associates Pty Ltd.
            ...
            allowed to according to the laws and regulations in the countries in
            which we operate.
          </p>
          ...
          <p className="mb-2">
            Once your request has been received the following actions will take
            place:
          </p>
          ...
          <p className="mb-6">
            ...
            absolute discretion review and change this Privacy Policy from time
            to time. The amended Privacy Policy will be published on Growmore &
            Associates Pty Ltd.’s website and will apply, whether or not,
            Growmore & Associates Pty Ltd has given you specific notice of any
            change. Check the Privacy Policy on Growmore & Associates Pty Ltd.’s
            website periodically if you would like to monitor any changes.
          </p>
          ...
          <p className="mb-2">
            ...
            suitability, reliability, or availability concerning the website or
            the information, products, services, or related graphics posted
          ...
          <p className="mb-6">
            Complaints: If you have a problem, please get in touch with us using
            the information listed below and give us all the specifics. We will
            swiftly look into your complaint, and then get back to you in
            writing with the findings of our inquiry and the actions we will
            take in response. You also have the option to get in touch with the
            Office of the Australian Information Commissioner and/or OMARA, if
            you’re not happy with our response.
          </p>
          <p className="mb-6">
            You can file a complaint with the lead supervisory authority or the
            data protection authorities in your country if you believe that we
            have violated your rights under the GDPR.
          </p>
          ...
          <p className="mb-6">
            ...
            to provide our services, and in some circumstances, we may be unable
          ...
          <p className="mb-[109.5px]">
            ...
            <span className="text-blue-600">info@growmore.one</span> in writing
            to Growmore & Associates Pty Ltd.
          </p>
        </div>
      </section>
    </div>
