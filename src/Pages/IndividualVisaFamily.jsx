...
const IndividualVisaFamily = () => {
  const url ="https://www.growmore.one/our-services/individual/family-visa/";

  return (
    <>
      <Helmet>
        <title>
          Family Sponsored Visa | Sibling Sponsorship Australia | GrowMore Immigration
        </title>

        <meta
          name="description"
          content="Explore Australian Family Sponsored Visa options with Growmore Immigration. Get expert guidance on sibling sponsorship and reunite with your family in Australia."
        />
        ...
        <meta
          property="og:title"
          content="Family Sponsored Visa | Sibling Sponsorship Australia | GrowMore Immigration"
        />
        <meta
          ...
          <section className="bg-[#28535B] py-12 sm:py-16">
            <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <p className="text-white font-medium mt-3 text-sm sm:text-base">
                ...
                &gt;{" "}
                <span className=" cursor-pointer">What is a Family Visa?</span>
              </p>
            </div>
          </section>
                ...
                <div>
                  ...
                  <ol className="list-decimal pl-6 mb-3 space-y-4 text-[#727272] text-sm sm:text-base">
                    <li>
                      ...
                      Zealand citizen. The child must be under 18 years of age
                    ...
                    <li>
                      ...
                      This visa is for parents of an Australian citizen,
                      permanent resident or eligible New Zealand citizen who are
                      aged 65 years or older. The visa allows them to live in
                      Australia permanently with their children and access to
                    ...
                    <li>
                      ...
                      This visa is for children of Australian citizens,
                      permanent residents or eligible New Zealand citizens who
                      are outside of Australia. The visa allows them to live in
                      Australia permanently with their parents.
                    </li>
                    <li>
                      <strong>
                        <span className="text-black font-semibold">
                          {" "}
                          Contributory Aged Parent (Temporary) visa (subclass
                          884) and Contributory Aged Parent visa (subclass 864):
                        </span>
                      </strong>
                    ...
                    <li>
                      ...
                      holders who are in Australia. The children must be under
                      18 years of age and meet the health and character
                      requirements.
                    </li>
                    <li>
                      <strong>
                      ...
                      family member in Australia and who want to come to
                    ...
                    <li>
                      ...
                      This visa is for parents of an Australian citizen,
                      permanent resident or eligible New Zealand citizen who are
                      willing to live in Australia permanently with their
                      children.
                    </li>
                    <li>
                      <strong>
                      ...
                      are in a married or de facto relationship with an
                      Australian citizen, permanent resident, or eligible New
                      Zealand citizen. The visa allows the partner to live in
                      Australia with their sponsor.
                    </li>
                    <li>
                      <strong>
                        <span className="text-black font-semibold">
                      ...
                      to an Australian citizen, permanent resident or eligible
                      New Zealand citizen and who want to come to Australia to
                      get married.
                    </li>
                    <li>
                      <strong>
                    ...
                    <li>
                      ...
                      This visa is for parents of an Australian citizen,
                      permanent resident or eligible New Zealand citizen who
                      want to come to Australia temporarily to be with their
                      children.
                    </li>
                  </ol>
