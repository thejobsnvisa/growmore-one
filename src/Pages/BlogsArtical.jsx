...
useEffect(() => {
    ...
    if (article) {
      ...
      const filePath = `${baseUrl}content/blogs/${slug}.md`.replace(/\/+/g, '/');
  ...
  return (
   <>
    <Helmet>
     ...
     <link rel="canonical" href={`https://www.growmore.one/blogs/${slug}`} />
     ...
     <meta property="og:url" content={`https://www.growmore.one/blogs/${slug}`} />
