...
const IndividualVisaGsm = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          General Skilled Migration Visa Program | GrowMore Immigration
        </title>

        <meta
          name="description"
          content="Use GrowMore Immigration to apply for a General Skilled Migration (GSM) Visa to Australia. Verify your eligibility, research different visa categories, and seek professional advice for a successful application."
        />
        ...
        <meta
          property="og:title"
          content="General Skilled Migration Visa Program | GrowMore Immigration"
        />
        <meta
                ...
                <div>
                  ...
                  <ol className="list-decimal pl-6 mb-3 space-y-4 text-[#727272] text-sm sm:text-base">
                    ...
                    <li>
                      ...
                      live and work in a specified regional area of Australia
                      for up to five years. To be eligible for this visa, you
                      need to have a positive skills assessment in an occupation
                      listed on the relevant skilled occupation list and meet
                      the point-based criteria. You also need to be sponsored by
                      an eligible family member or nominated by a state or
                    ...
                    <li>
                      ...
                      individuals who have lived and worked in regional
                      Australia on a provisional visa for three years, and have
                      met the requirements of their visa.
                    </li>
                  </ol>

                  <p className="text-[#727272] mb-3 leading-relaxed  text-justify text-sm sm:text-base">
                    Eligibility criteria for this visa include holding a
                    relevant provisional visa, having lived and worked in
                    regional Australia for at least three years, meeting the
                    health and character requirements, and having an occupation
                    listed on the{" "}
                    <span className="text-black font-semibold">
