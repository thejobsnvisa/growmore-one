...
const GSMPage = () => {
 const url ="https://www.growmore.one/our-services/gsm-general-skilled-migration";
  return (
    <>
      <Helmet>
        <title>
           General Skilled Migration Australia | Subclass 189, 190 & 491 PR
        </title>

        <meta
          name="description"
          content="Unlock your pathway to Australian PR. Expert guidance on General Skilled Migration (GSM), including 189, 190, and 491 visas. Check your points eligibility today!"
        />
        ...
        <meta
          property="og:title"
          content=" General Skilled Migration Australia | Subclass 189, 190 & 491 PR"
        />
        <meta
      ...
      <div className="bg-white">
        ...
        <section className="max-w-[1400px] mx-auto px-6 py-10 md:px-15 py-16">
          ...
          <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 mb-3 leading-snug">
            Migrate to Australia with the General Skilled Migration (GSM)
            Program –
          ...
          <p className="text-[#727272] leading-relaxed mb-10 text-justify">
            ...
            points-based pathway to permanent residency – no employer
            sponsorship required. This program is specially designed for those
            whose skills are in high demand in Australia. Whether you're an IT
            professional, engineer, nurse, or tradesperson, GSM could be your
            gateway to building a successful future in Australia.
          </p>
          ...
          <div className="mb-10">
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
              <li>
                Flexibility to Live and Work Anywhere (Especially for 189)
              </li>
          ...
          <div className="mb-12">
            ...
            <p className="text-[#727272] mb-3 text-justify">
              Take the first step towards securing your general skilled
              migration without the need for sponsorship and building a new life
              in Australia. Get a free GSM eligibility assessment now. It only
              takes a few minutes and helps identify the best pathway for you.
            </p>
          ...
          <div>
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-8">
              <li>
                Licensed MARA agents to provide you with the right guidance in
                the Labour Agreement
              </li>
              <li>Thousands of successful visa approvals and happy clients</li>
              <li>Strong connections with Australian employers</li>
            ...
            <p className="text-[#727272] mb-3 text-justify">
              Stay connected with Growmore Immigration for the latest tips,
              news, and expert insights on migrating to Australia. Follow us on
              social media and be a valuable part of our community.
            </p>
