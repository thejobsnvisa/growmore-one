        ...
        <section className="py-20">
          <div className="max-w-7xl mx-auto px-6 md:px-16 grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-semibold text-gray-800 leading-tight mb-10">
                Leading with <span className="text-[#8FD07C]">Experts</span>
                <br />
              ...
              <div className="flex items-start gap-4 mb-10">
                <p className="text-gray-600 leading-relaxed text-justify">
                  ...
                  receives the most accurate advice and tailored solutions.
                  Under Krunal’s guidance, we’ve built a culture of trust,
                  innovation, and excellence that defines Growmore Immigration.
                </p>
              </div>
