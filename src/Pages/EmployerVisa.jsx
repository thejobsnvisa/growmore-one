...
const EmployerVisa = () => {
  const url = "https://www.growmore.one/our-services/employers";
  return (
    <>
      <Helmet>
        <title>Employer Sponsored Visa Services (482, 186, 494) | Growmore</title>

        <meta
          name="description"
          content="Streamline your business sponsorship. We assist Australian employers with Subclass 482, 186, and 494 visas. Secure skilled global talent with expert guidance."
        />
          ...
          <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div className="md:col-span-2 pl-6 sm:pl-40 lg:pl-45">
              ...
              <p className="text-[#727272] mt-6 leading-relaxed text-justify  text-sm sm:text-base">
                ...
                greatly depending on the type of visa and the specific
                occupation, so it is important to carefully review the
              ...
              <div>
                ...
                <ul className="list-disc pl-6 mt-6 space-y-4 text-[#727272] text-sm sm:text-base">
                  <li>
                    ...
                    sponsor a foreign worker if they are unable to find a
                    suitable candidate locally to fill a skilled position.
                  </li>

                  <li>
                    <strong>Access to a global talent pool:</strong> Employer
                    sponsorship allows companies to access a wider pool of
                    talent from around the world, increasing their ability to
                    find the best candidate for the job.
                  </li>

                  <li>
                    <strong>Retention of valuable employees:</strong> Sponsoring
                    a valued employee for a visa can help to retain them, as it
                    shows the company’s commitment to their role and their
                    future in the company.
                  </li>

                  <li>
                    <strong>Meeting business needs:</strong> Employer
                    sponsorship can enable a company to meet its business needs
                    by bringing in foreign workers with specific skills and
                    knowledge that are required to support the business.
                  </li>

                  <li>
                    <strong> Compliance with immigration laws:</strong> Employer
                    sponsorship can help companies comply with immigration laws
                    by ensuring that their foreign employees are in Australia
                    legally and have the necessary visas to work.
                  </li>

                  <li>
                    <strong>Positive impact on company culture:</strong>Employer
                    sponsorship can bring a positive impact on company culture
                    by creating a diverse and inclusive workplace, where
                    employees from different backgrounds can collaborate and
